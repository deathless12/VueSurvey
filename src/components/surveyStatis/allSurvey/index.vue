    	...
    	<el-table
	      ...
	      <el-table-column label="操作" align="center" width="250">
		      <template slot-scope="scope">
            	...
            	<el-button type="info" round @click="handleDownload(scope.$index, scope.row)" size="mini">下载</el-button>
            	<el-button type="danger" round @click="handleStatis(scope.$index, scope.row)" size="mini">课调分析</el-button>
		      </template>
		    </el-table-column>
	    </el-table>
    </div>
...
export default {
  ...
  computed:{
  	...
  	...mapGetters(['grades','clazzVM','courses','naires','passSurvey']),
  },
  created(){
  ...
  methods:{
  	...
  	...mapActions(['findAllGrade','findAllClazzVM','findAllCourse','findAllNaire','findAllSurvey'])
  },
}
</script>
<style scoped>
